...
El parcial se puede realizar de manera grupal, la entrega del mismo se hace individual. Aquel alumno que no entregue no recibirá calificación, por mas de que los otros compañeros hayan entregado y mencionado dentro del trabajo.

Lea atentamente la consigna y desarrolle la simulación solicitada aplicando los contenidos trabajados en la materia.

Se espera que la solución implementada integre de manera coherente los conceptos de agentes autónomos, steering behaviours, flocking y máquina de estados, evidenciando un correcto funcionamiento del sistema.

1. ENTREGABLES OBLIGATORIOS
La rúbrica se aplicará únicamente si el estudiante cumple con la entrega completa de los siguientes requisitos obligatorios. Si alguno de ellos no está presente, no es accesible o no cumple con el formato solicitado, el parcial será considerado desaprobado.

Se deberá entregar un archivo PDF con el siguiente formato de nombre:

Apellido Nombre Parcial #.pdf

Ej: Iaria Matias Parcial 1.pdf

El PDF deberá contener:

Nombre y apellido de todos los integrantes del grupo.

Un enlace al repositorio de GitHub, donde se encuentre subido el proyecto completo de Unity 3D.

En caso de trabajar de forma grupal, los miembros deberán aclarar brevemente en que trabajo cada uno.

El Proyecto deberá estar en la versión 6000.3.17f1 de unity.

Asegurarse que GitHub sea “Público”.
...
1.1 CONSIGNA
Requerimientos para los agentes con Flocking (Boids)
...
Requerimientos para el NPC Cazador
...
Un enlace al repositorio de GitHub (Publico), donde se encuentre subido el proyecto completo de Unity 3D.

El trabajo podrá ser:

Individual o en grupos de hasta 2 integrantes

El proyecto debe:

Estar desarrollado en la versión de Unity utilizada en la cursada

No presentar crashes ni errores críticos

El parcial será considerado desaprobado si no existe implementación de:
